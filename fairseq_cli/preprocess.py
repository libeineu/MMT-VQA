...
def main(args):
    ...
    if args.task == "mmt_vqa":
        _make_binary_dataset(src_dict, input_prefix=args.trainpref, output_prefix='train', lang='query', num_workers=args.workers, args=args)
        _make_binary_dataset(src_dict, input_prefix=args.trainpref, output_prefix='train', lang='ans', num_workers=args.workers, args=args)
