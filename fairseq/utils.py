...
class Recorder():   # follow Revisit-MMT
    def __init__(self, args):
        ...
        # gate_path = os.path.join('checkpoints/mmt_vqa_mae_final/rb_visual_test2018/gate.txt')
        self.map_path = os.path.join('checkpoints/mmt_mae_final/rb_visual_test2018')
